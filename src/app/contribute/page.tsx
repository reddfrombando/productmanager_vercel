...
export default function ContributePage() {
  ...
  const [suggestedTopicTitle, setSuggestedTopicTitle] =
    useState("");

  const [
    suggestedTopicDuration,
    setSuggestedTopicDuration,
  ] = useState("15 mins");
  ...
  const moduleTopics = allTopics.filter(
    (topic) =>
      topic.moduleId === Number(selectedModuleId)
  );
  ...
  const handleSubmit = async (
    ...
    if (
      topicId === "suggest-new" &&
      !suggestedTopicTitle.trim()
    ) {
      alert(
        "Please enter a title for the suggested topic."
      );
      return;
    }
        ...
        <main className="flex-1 p-6 md:p-8 overflow-y-auto max-h-[calc(100vh-73px)] space-y-6 max-w-2xl">
          ...
          <div>
            ...
            <p className="text-xs text-primary/50 mt-1 font-sans">
              Help us enrich the PM Foundations syllabus.
              Recommend a video, template, book, or article
            ...
            {!success ? (
              ...
              >
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="font-bold text-primary/60">
                      Contributor Name
                    </label>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      ...
                      <option value="suggest-new">
                        + Suggest a new topic under
                        this module...
                      </option>
                    </select>
                  </div>
                ...
                {topicId === "suggest-new" && (
                  <div className="bg-[#F8FAFC]/55 border border-border-light/75 rounded-2xl p-4 grid sm:grid-cols-2 gap-4 animate-fadeIn">
                    ...
                    <div className="space-y-1.5">
                      <label className="font-bold text-primary/60">
                        Suggested Duration (e.g. 15 mins)
                      </label>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="gradient-bg w-full rounded-xl py-3 text-xs font-bold text-white shadow-md hover:opacity-95 transition-opacity flex items-center justify-center space-x-1.5 cursor-pointer mt-6 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <span>
                    {submitting
                      ? "Submitting..."
              ...
              <div className="text-center py-6 space-y-4 font-sans text-xs">
                ...
                <p className="text-primary/60 max-w-sm mx-auto font-medium">
                  Thank you! Your recommendation has
                  been added to our validation pipeline.
