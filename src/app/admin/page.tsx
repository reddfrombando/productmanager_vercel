                              ...
                              {sub.status === "Pending" ? (
                                <div className="flex items-center justify-end space-x-2">
                                  ...
                                  <button
                                    ...
                                    className="h-7 w-7 rounded-lg border border-emerald-200 text-emerald-500 hover:bg-emerald-50 flex items-center justify-center cursor-pointer transition-colors shadow-sm"
                                    title="Approve"
                                  >
                        ...
                        <div className="w-full flex items-center justify-between p-4 bg-[#F8FAFC]/40 border-b border-border-light/60">
                          ...
                          <div className="flex items-center space-x-4 shrink-0">
                            ...
                            <button
                              ...
                              className="bg-accent-purple/5 hover:bg-accent-purple text-accent-purple hover:text-white border border-accent-purple/20 px-2.5 py-1 rounded-lg text-[9px] font-bold transition-all cursor-pointer"
                            >
                              + Add Topic
                            </button>
                            <button
